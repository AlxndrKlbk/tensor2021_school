...
<div class="create_location">
    <b-button @click="saveLocation" class="button_save" type="is-success" outlined>
        СОХРАНИТЬ
    </b-button>
      <div class="input_name_location">
          <input v-model="nameleLocation" class="input is-medium" type="text"  placeholder="Введите название локации" >
      </div>
      <div class="input_article_location">
        <div class="input_article_location_title">ОПИСАНИЕ К ЛОКАЦИИ</div>
        <textarea v-model="articleLocation" class="textarea" placeholder="Введите описание локации"></textarea>
      </div>
